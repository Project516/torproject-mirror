...
4. Deletes the existing "latest" release
5. Creates a new "latest" release with all the downloaded files
6. Updates the `index.html` page with version information
